...
class OneFileLoginApplication
{
    ...
    private function showPageLoggedIn()
    {
        ...
        echo '<div class="well well-sm">You are logged in as '. $_SESSION['user_name'] . '.';
        echo '&nbsp <a href="' . $_SERVER['SCRIPT_NAME'] . '?action=logout">Log out</a></div>';
    }
    /**
